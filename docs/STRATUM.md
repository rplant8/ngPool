...
```javascript
{ "id": 1, "jsonrpc": "2.0", "method": "ngin_getWork" }
```
...
`ngin_submitHashrate` is a nonsense method. Pool ignores it and the reply is always:
